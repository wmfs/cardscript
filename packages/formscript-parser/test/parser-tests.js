...
describe('Run Formscript parsing tests', function () {
  it('should parse some simple Formscript JSON', function () {
  ...
  it('should parse some complex Formscript JSON', function () {
  ...
  it('should fail to parse nonsense', function () {
    const result = parse('THIS IS NOT VALID FORMSCRIPT!')
    expect(result.errors[0].property).to.eql('string')
