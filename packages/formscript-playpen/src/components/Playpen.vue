<template>
  <div class="container">
    <div class="jumbotron">
      ...
      <p class="lead">Hack around with some Formscript JSON in the editor below and then click the
        "<strong>Parse!</strong>" button to try it out. Please take a look at the <a
