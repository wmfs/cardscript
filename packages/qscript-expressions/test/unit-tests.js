...
const QScriptExpressionsxpressions = require('../lib/')
const expressions = new QScriptExpressionsxpressions()
const expressionForm = require('./../../qscript-examples/lib/examples/expression')
...
describe('Loads of tests enit', function () {
  it('Should get the list of expressions from the simple QScript', done => {
    const exp = expressions.getExpressionsFromQScript(expressionForm)
    expect(exp).to.eql(
      [
        {
          widget: 'feedback',
...
describe('Nested tests', function () {
  it('Should get the list of expressions from the nested QScript', done => {
    widgetNames = []
    expressions.asts = {}
    const exp = expressions.getExpressionsFromQScript(nestedForm)
    expect(exp).to.eql(
      [
