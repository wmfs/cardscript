...
describe('Run some QScript list-extracting tests', function () {
  it('should extract no list from some simple QScript', function () {
  ...
  it('should extract some lists from complex QScript', function () {
