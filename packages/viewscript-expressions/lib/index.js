...
class ViewscriptExpressions {
  constructor () {
    this.asts = {}
  }

  getExpressionsFromViewscript (viewscript) {
  ...
  addViewscript (viewscript) {
    const expressions = this.getExpressionsFromViewscript(viewscript)
    this.convertExpressionsToAst(expressions)
  }

  calculateWidgetVisibility (viewscript, data, asts) {
    let setVisible = [true]
...
module.exports = ViewscriptExpressions
