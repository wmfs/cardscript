...
const ViewscriptExpressions = require('../lib/')
...
describe('Loads of tests enit', function () {
  it('Should get the list of expressions from the simple Viewscript', done => {
    const exp = expressions.getExpressionsFromViewscript(expressionForm)
    expect(exp).to.eql(
      [
        {
          widget: 'feedback',
...
describe('Nested tests', function () {
  it('Should get the list of expressions from the nested Viewscript', done => {
    widgetNames = []
    expressions.asts = {}
    const exp = expressions.getExpressionsFromViewscript(nestedForm)
    expect(exp).to.eql(
      [
