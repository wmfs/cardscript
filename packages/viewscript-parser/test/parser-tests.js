...
describe('Run Viewscript parsing tests', function () {
  it('should parse some simple Viewscript JSON', function () {
  ...
  it('should parse some complex Viewscript JSON', function () {
